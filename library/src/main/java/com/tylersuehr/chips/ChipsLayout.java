 ...
 * @version 1.0
 */
public class ChipsLayout extends MaxHeightScrollView
    ...
    private RecyclerView mChipsRecycler;
    ...
    public ChipsLayout(Context c, AttributeSet attrs) {
        super(c, attrs);
        mDataSource = new ListChipDataSource();
        // Inflate the view
        inflate(c, R.layout.layout_chips, this);

    }

    public void setChipsLayout(Context c, AttributeSet attrs, ChipOptions chipOptions, EditText editText,
        ...
        mChipsAdapter = new ChipsAdapter(
                mDataSource, editText, mOptions, loadHolder(), listener);
    ...
    public void setInputTextColor(ColorStateList textColor) {
        ...
        if (editText != null) { // Can be null because its lazy loaded
